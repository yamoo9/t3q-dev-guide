...
async function generateSvgSprite() {
  ...
  await exec(
    `npx svg-sprite --svg-xmldecl=false --svg-doctype=false -s --symbol-prefix='' --symbol-sprite='${FILENAME}' --symbol-bust=false --symbol-example=false --symbol-dest=${OUT_DIR} '${INPUT_DIR}/**/*.svg'`,
    errorCallback
  );
}
